function About () {
    return (<>
        ...
        <h2>Notice</h2>
        <ul>
            <li>Babbel compiles JSX Code, if {'<script type="text/babel"></script>'} Tags are provided with the type="text/babel" Attribute.</li>
            ...
            <li>Scripts MUST be loaded in the right order, because Scripts on the bottom depend on the Scripts at the top.</li>
